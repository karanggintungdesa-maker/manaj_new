...
export default function MonitoringAbsensiGrid() {
  ...
  const isAuthorized = user?.email?.toLowerCase() === "admin@karanggintung.id" || 
                       user?.email?.toLowerCase() === "karanggintung@gmail.id" || 
                       user?.email?.toLowerCase() === "karanggintungdesa@gmail.com";
