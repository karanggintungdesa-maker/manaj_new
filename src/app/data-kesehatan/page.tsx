...
export default function DataKesehatanPage() {
  ...
  const handleExport = () => {
    ...
    XLSX.writeFile(wb, `Data_Kesehatan_${activeTab.replace(/\s+/g, '_')}_karanggintung.xlsx`)
  }
          ...
          <div className="space-y-5 py-6">
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                placeholder="CONTOH: RT 04 RW 05 DESA KARANGGINTUNG" 
                className="h-12 rounded-xl uppercase" 
              />
            </div>
            <div className="space-y-2">
              ...
              <Input 
                ...
                placeholder="CONTOH: FLAMBOYAN 3" 
                className="h-12 rounded-xl uppercase" 
              />
            </div>
          </div>
