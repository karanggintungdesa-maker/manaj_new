...
export default function LoginPage() {
  ...
  async function onSubmit(values: z.infer<typeof loginSchema>) {
    ...
    const ALLOWED_EMAIL = "karanggintung@gmail.id"
    const ALLOWED_PASS = "karanggintung123"
      ...
      <Card className="w-full max-w-md shadow-2xl border-none rounded-[2.5rem] overflow-hidden bg-card">
        <CardHeader className="text-center space-y-4 pb-4 pt-12 relative">
          ...
          <div className="space-y-1">
            ...
            <CardDescription className="font-bold text-[10px] uppercase tracking-widest opacity-60">Pemerintah Desa Karanggintung</CardDescription>
          </div>
        </CardHeader>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input 
                          placeholder="karanggintung@gmail.id" 
                          {...field} 
